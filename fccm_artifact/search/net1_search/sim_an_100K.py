...
# Load the CSV files
csv1 = pd.read_csv('conv_fccm.csv')

csv3 = pd.read_csv('dense_fccm.csv')


# Combine all CSVs into one DataFrame
combined_df = pd.concat([csv1, csv3])
...
def simulated_annealing(df, iterations=100000, initial_temp=100, cooling_rate=0.99):
...
results_csv = f'simulated_annealing_results_100K_{timestamp}.csv'
results_txt = f'simulated_annealing_output__100K_{timestamp}.txt'
