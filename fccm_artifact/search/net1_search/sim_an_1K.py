...
def simulated_annealing(df, iterations=1000, initial_temp=100, cooling_rate=0.99):
...
results_csv = f'simulated_annealing_results_1K_{timestamp}.csv'
results_txt = f'simulated_annealing_output__1K_{timestamp}.txt'
