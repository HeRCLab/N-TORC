...
if IF_RUNNING_FOR_MORE_ACCURATE_MODEL:
    out_file_tag = 'results/more_accurate_model/'+optuna_sampler_tag + '_v1'
    result_path = 'results/more_accurate_model/main_results_'+optuna_sampler_tag
    rmse_cost_path = 'results/more_accurate_model/rmse_cost_'+optuna_sampler_tag
    acc_pin_ref_pred_filepath = 'results/more_accurate_model/'
    ...
    out_file_tag = 'results/less_accurate_model/'+optuna_sampler_tag + '_v1'
    result_path = 'results/less_accurate_model/main_results_'+optuna_sampler_tag
    rmse_cost_path = 'results/less_accurate_model/rmse_cost_'+optuna_sampler_tag
    acc_pin_ref_pred_filepath = 'results/less_accurate_model/'
